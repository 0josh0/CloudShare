...
public class ErrorCode {
	...
	public static final ErrorCode USER_NOT_ACTIVE = new ErrorCode(403, 1);
	public static final ErrorCode DEVICE_REVIEW_REQUIRED = new ErrorCode(403, 5, "device review required");
	public static final ErrorCode DEVICE_DISABLED = new ErrorCode(403, 6, "device disabled");
