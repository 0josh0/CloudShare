...
import cn.ac.iscas.oncecloudshare.service.extensions.index.service.IndexConfigs;
 ...
 */
@Service
public class WIndexNotifyService {
	private static Logger logger = LoggerFactory.getLogger(WIndexNotifyService.class);
	...
	private void init() {
		...
		String queueName = notifConfigs.getSPACE_QUEUE();
