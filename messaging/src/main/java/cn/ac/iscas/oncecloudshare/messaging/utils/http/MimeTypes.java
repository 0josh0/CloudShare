package cn.ac.iscas.oncecloudshare.messaging.utils.http;
...
public class MimeTypes {
	...
	static{
		mimeTypeMapping=new HashMap<String,String>(200){
...

			{
				...
				put1("pptx",MIME_APPLICATION_VND_MSPOWERPOINT);
				...
				put1("xlsx",MIME_APPLICATION_VND_MSEXCEL);
	...
	public static String lookupMimeTypeByFilename(String filename){
		String ext=FilenameUtils.getExtension(filename);
		return mimeTypeMapping.get(ext.toLowerCase());
	}
}
