...
public class BoshHandler implements ServerRuntimeContextService {
    ...
    protected Stanza getSessionCreationResponse(BoshBackedSessionContext session) {
         ...
         * modify
         */
        Stanza features = getFeaturesForAuthentication(serverRuntimeContext.getServerFeatures()
    ...
    /**
     * 从ServerResponses复制来的
     */
    private static Stanza getFeaturesForAuthentication(List<SASLMechanism> authenticationMethods, SessionContext sessionContext) {
