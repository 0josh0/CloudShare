...
@Controller
@RequestMapping(value = "/adminapi/v2/logs", produces = { MediaTypes.TEXT_PLAIN_UTF8, MediaTypes.JSON_UTF8 })
public class AdminActionLogController extends BaseController {
	...
	public String search(@RequestParam(required = false) String q, PageParam pageParam) {
		...
		return Gsons.filterByFields(ActionLogDto.class, pageParam.getFields()).toJson(PageDto.of(page, ActionLogDto.forAdmin));
	}
}